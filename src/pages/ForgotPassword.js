        ...
        <div className="h-screen overflow-hidden flex items-center justify-center">
            <section className="min-h-screen flex items-stretch text-white">
                <div className="lg:flex w-1/2 hidden bg-gray-500 bg-no-repeat bg-cover relative items-center"
                 style={{ backgroundImageURL:"https://images.unsplash.com/photo-1577495508048-b635879837f1?ixid=MXwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHw%3D&ixlib=rb-1.2.1&auto=format&fit=crop&w=675&q=80" }}
                >
                    ...
                    <div className="w-full py-6 z-20">
                        ...
                        <form className="sm:w-2/3 w-full px-4 lg:px-0 mx-auto" onSubmit={ handleSubmit }>
                            ...
                            <div className="px-4 pb-2 pt-4">
                                <button disabled={loading} className="uppercase block w-full p-4 text-lg rounded-full bg-indigo-500 hover:bg-indigo-600 focus:outline-none" type="submit">Reset Password</button>
                            </div>
