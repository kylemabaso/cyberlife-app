...
export default function LogIn() {
    ...
    return (
        <div className="min-h-full flex flex-col overflow-auto h-full">
            <section className="min-h-screen flex items-stretch text-white">
                <div className="lg:flex w-1/2 hidden bg-gray-500 bg-no-repeat bg-cover relative items-center"
                 style={{ backgroundImageURL:"https://images.unsplash.com/photo-1559827291-72ee739d0d9a?ixid=MXwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHw%3D&ixlib=rb-1.2.1&auto=format&fit=crop&w=800&q=80" }}
                >
                    <div className="absolute opacity-60 inset-0 z-0"></div>

                    {/* Welcome */}
                    <div className="w-full px-24 z-10">
                        <h1 className="text-5xl font-bold text-left tracking-wide">Welcome to Cyberlife</h1>
                        <p className="text-3xl my-4">Create a different life in an alternate reality!</p>
                    </div>
                ...
                <div className="lg:w-1/2 w-full flex items-center justify-center text-center md:px-16 px-0 z-0" style={{backgroundColor: "#161616"}}>
                    ...
                    <div className="w-full py-6 z-20">
                        ...
                        <h1 className="my-6 justify-center flex">
                            <img src={logo} alt="Cyberlife" style={{height: "50px"}} />
                        </h1>
                        ...
                        <div className="py-6 space-x-2">
                            ...
                            <span className="w-10 h-10 items-center justify-center inline-flex rounded-full font-bold text-lg border-2 border-white" onClick={authWithGoogle} style={{ cursor:'pointer'}}>G+</span>
                        ...
                        <p className="text-gray-100">or <Link to="/signup">Create a new Account</Link></p>
                       ...
                       { error &&  <span>{ error }</span> }
                        ...
                        <form className="sm:w-2/3 w-full px-4 lg:px-0 mx-auto" onSubmit={ handleSubmit }>
                            ...
                            <div className="px-4 pb-2 pt-4">
                                <button disabled={loading} className="uppercase block w-full p-4 text-lg rounded-full bg-indigo-500 hover:bg-indigo-600 focus:outline-none" type="submit">Login</button>
                            </div>
